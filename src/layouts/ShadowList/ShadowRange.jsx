...
export default function ShadowRange({inputData, shadowID}) {
  ...
  return (
    <div className="my-4">
      ...
      <div className="relative z-0 w-full items-center">
          <input 
              value={inputData.value}
              onChange={handleInput}
          ...
          />
          <div className="absolute -z-10 top-2/3 left-1/2 -translate-y-1/2 -translate-x-1/2 w-0.5 h-10 bg-gray-300 rounded"></div>
      </div>
    </div>
  )
}
